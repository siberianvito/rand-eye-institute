      ...
      <div className="shell relative text-center">
        ...
        <Reveal delay={220}>
          <div className="mt-10 flex flex-col items-center justify-center gap-3.5 sm:flex-row">
            <Link
              href={CONSULT_PATH}
              className="brand-gradient btn-alive group inline-flex items-center justify-center gap-2.5 rounded-full px-8 py-4.5 text-base font-semibold text-white [--sweep-delay:0.8s] cursor-pointer"
            >
